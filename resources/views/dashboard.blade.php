        ...
        <div class="main-panel">
            <div class="content-wrapper pb-0">
                <div class="page-header flex-wrap">
                    <h3 class="mb-0"> Hoşgeldin, {{ Auth::user()->name }} <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Verilerin bizimle güvende; dilediğin zaman, dilediğin yerden erişim sağlayabilirsin.</span>
                    </h3>
                </div>
                <div class="row">
