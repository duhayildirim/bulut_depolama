                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face1.jpg" alt="image" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face10.jpg" alt="image" />
                                                    <div class="table-user-name ml-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face11.jpg" alt="image" />
                                                    <div class="table-user-name ml-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face13.jpg" alt="image" />
                                                    <div class="table-user-name ml-3">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face16.jpg" alt="image" />
                                                    <div class="table-user-name ml-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                                    <img class="survey-img mb-lg-3" src="<?php echo e(asset('panel')); ?>/assets/images/dashboard/img_3.jpg" alt="" />
                                    <div class="pt-2">
                                ...
                                <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                                    <img class="survey-img mb-lg-3" src="<?php echo e(asset('panel')); ?>/assets/images/dashboard/img_1.jpg" alt="" />
                                    <div class="pt-2">
                                ...
                                <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                                    <img class="survey-img mb-lg-3" src="<?php echo e(asset('panel')); ?>/assets/images/dashboard/img_2.jpg" alt="" />
                                    <div class="pt-2">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-12 col-sm-7">
                                        <div class="row">
                                            <div class="col-4 col-md-4">
                                                <img class="customer-img" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face22.jpg" alt="" />
                                            </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="row">
                                            <div class="col-4 col-sm-4">
                                                <img class="customer-img" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face25.jpg" alt="" />
                                            </div>
                                ...
                                <div class="row py-1">
                                    <div class="col-sm-7">
                                        <div class="row">
                                            <div class="col-4 col-sm-4">
                                                <img class="customer-img" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face15.jpg" alt="" />
                                            </div>
                                            <div class="col-8 col-sm-8 p-sm-0">
                                ...
                                <div class="row py-1">
                                    <div class="col-sm-7">
                                        <div class="row">
                                            <div class="col-4 col-sm-4">
                                                <img class="customer-img" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face5.jpg" alt="" />
                                            </div>
                                            <div class="col-8 col-sm-8 p-sm-0">
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        <div class="row">
                                            <div class="col-4 col-sm-4">
                                                <img class="customer-img" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face2.jpg" alt="" />
                                            </div>
                                            <div class="col-8 col-sm-8 p-sm-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                                    <div class="col-sm-9 pl-0">
                                        <div class="d-flex">
                                            <img src="<?php echo e(asset('panel')); ?>/assets/images/dashboard/img_4.jpg" alt="" />
                                            <div class="pl-2">
                                ...
                                <div class="row py-3 align-items-center mx-0">
                                    <div class="col-sm-9 pl-0">
                                        <div class="d-flex">
                                            <img src="<?php echo e(asset('panel')); ?>/assets/images/dashboard/img_5.jpg" alt="" />
                                            <div class="pl-2">
                        ...
                        <span class="dropdown dropleft d-block">
                          ...
                          <span class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face1.jpg" alt="" />
                              <img class="ml-1" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face10.jpg" alt="" />
                              <img class="ml-1" src="<?php echo e(asset('panel')); ?>/assets/images/faces/face14.jpg" alt="" />
                            </span>
                          </span>
                                        </p>
                                    </li>
                                ...
                                <div class="list-card">
                                    <div class="row align-items-center">
                                        <div class="col-7 col-sm-8">
                                            <div class="row align-items-center">
                                                <div class="col-sm-4">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face2.jpg" alt="" />
                                                </div>
                                ...
                                <div class="list-card">
                                    <div class="row align-items-center">
                                        <div class="col-7 col-sm-8">
                                            <div class="row align-items-center">
                                                <div class="col-sm-4">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face3.jpg" alt="" />
                                                </div>
                                                <div class="col-sm-8 pr-0 pl-sm-0">
                                ...
                                <div class="list-card">
                                    <div class="row align-items-center">
                                        <div class="col-7 col-sm-8">
                                            <div class="row align-items-center">
                                                <div class="col-sm-4">
                                                    <img src="<?php echo e(asset('panel')); ?>/assets/images/faces/face11.jpg" alt="" />
                                                </div>
                                                <div class="col-sm-8 pr-0 pl-sm-0">
