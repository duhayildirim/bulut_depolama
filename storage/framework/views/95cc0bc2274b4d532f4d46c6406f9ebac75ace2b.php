                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-3">
                                    <div class="card" style="width: 11rem;margin: 4rem;border: none !important;">
                                        <img class="card-img-top" src="<?php echo e(asset('panel')); ?>/assets/images/faces/mp3.png" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Dosya Adı</h5>
                                            <a href="<?php echo e(route('fad.data.index')); ?>" type="button" class="btn btn-success"> İndir</a>
                                ...
                                <div class="col-xl-3 col-lg-3">
                                    <div class="card" style="width: 11rem;margin: 4rem;border: none !important;">
                                        <img class="card-img-top" src="<?php echo e(asset('panel')); ?>/assets/images/faces/pdf.png" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Dosya Adı</h5>
                                            <a href="<?php echo e(route('fad.data.index')); ?>" type="button" class="btn btn-success"> İndir</a>
                                            <a type="button" class="btn btn-danger"> Sil</a>
                                ...
                                <div class="col-xl-3 col-lg-3">
                                    <div class="card" style="width: 11rem;margin: 4rem;border: none !important;">
                                        <img class="card-img-top" src="<?php echo e(asset('panel')); ?>/assets/images/faces/text.png" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Dosya Adı</h5>
                                ...
                                <div class="col-xl-3 col-lg-3">
                                    <div class="card" style="width: 11rem;margin: 4rem;border: none !important;">
                                        <img class="card-img-top" src="<?php echo e(asset('panel')); ?>/assets/images/faces/video.png" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Dosya Adı</h5>
                                            <a type="button" class="btn btn-success"> İndir</a>
                                            <a type="button" class="btn btn-danger"> Sil</a>
                                ...
                                <div class="col-xl-3 col-lg-3">
                                    <div class="card" style="width: 11rem;margin: 4rem;border: none !important;">
                                        <img class="card-img-top" src="<?php echo e(asset('panel')); ?>/assets/images/faces/excel.png" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">Dosya Adı</h5>
                                            <a type="button" class="btn btn-success"> İndir</a>
                                            <a type="button" class="btn btn-danger"> Sil</a>
